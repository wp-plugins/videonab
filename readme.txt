=== VideoNab ===
Contributors: joshsears31
Donate link: http://example.com/
Tags: add videos, youtube videos, video comments, add my videos, list videos
...
VideoNab allows you to add a powerful video stream to your site within an awesome design.
Web version of this documentation (with images) can be found here: http://www.videonab.com/videonablite-documentation/
...
1. Manually add videos to your site via a simple interface 2. Facebook commenting system for each video 3. All videos are organized in a modern design fit for all sites 4. Specify the number of videos to display, and other customizations 5. Fully Responsive for displaying videos on all devices 6. Designed to visually integrate into any WordPress theme7. Sharing system that links other users directly to your site instead of YouTube 8. Re-title Videos and their descriptions as needed 9. Edit permalink titles of videos as needed and enhance SEO 10. Latest YouTube API 11. Pro version available with automated video aggregation, voting, and more!
